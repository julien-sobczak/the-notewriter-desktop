...
export default class ConfigManager {
  ...
  //   Ex: list of collections, journaling templates, etc.
  ...
  commitDeck(deckRef: DeckRef) {
    ...
    */
    ...
    // Append the commit in the commit graph
    const commitGraphData = fs.readFileSync(commitGraphPath);
    const commitGraph = yaml.load(commitGraphData) as CommitGraph;
    commitGraph.commits.push(commit);
    const commitGraphRaw = yaml.dump(commitGraph);
    fs.writeFileSync(commitGraphPath, commitGraphRaw);
